        ...
        <div className="min-h-screen w-full bg-[#F8FAFC] relative overflow-hidden">
            ...
            <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 relative z-10 space-y-5 animate-in fade-in duration-500">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-4">
                    ...
                    <Button className="bg-slate-900 hover:bg-slate-800 text-white rounded-xl font-bold text-xs uppercase tracking-wider shadow-lg shadow-slate-900/20 gap-2 px-6 h-9 hover:scale-105 active:scale-95 transition-all">
                        <UserPlus className="h-4 w-4" />
                        Add Staff Member
                    </Button>
                </div>

                <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 p-2.5 rounded-2xl flex flex-col md:flex-row gap-4 items-center justify-between shadow-sm backdrop-blur-md">
                    <div className="relative w-full md:w-96">
                        ...
                        <Input 
                            ...
                            className="pl-10 h-9 border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/50 rounded-xl text-xs"
                        />
                    </div>
                    <div className="flex items-center gap-2">
                        <Button variant="outline" className="h-9 rounded-xl border-slate-200 dark:border-slate-800 gap-2 font-bold text-xs uppercase">
