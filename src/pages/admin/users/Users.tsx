                            ...
                            <div>
                                <div className="w-full">
                                        ...
                                        <Table>
                                            <TableHeader className="bg-slate-50">
                                                <TableRow className="border-slate-200 hover:bg-transparent">
                                                    <TableHead className="px-3 py-2 text-[9px] font-black text-slate-500 uppercase tracking-wider w-[32%]">User</TableHead>
                                                    <TableHead className="px-3 py-2 text-[9px] font-black text-slate-500 uppercase tracking-wider w-[33%]">Email</TableHead>
                                                    <TableHead className="px-3 py-2 text-[9px] font-black text-slate-500 uppercase tracking-wider text-center w-[15%]">Role</TableHead>
                                            ...
                                            <TableBody>
                                                {users?.map((user) => (
                                                    <TableRow key={user?.id} className="border-slate-100 hover:bg-slate-50 transition-all duration-200 group">
                                                                ...
                                                                <div className="min-w-0 flex-1">
                                                                    ...
                                                                    <div className="flex items-center gap-1">
                                                                        <div className="flex items-center gap-0.5">
                                                                            ...
                                                                            <span className="text-[7.5px] font-bold text-emerald-600 uppercase">ACTIVE</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <TableCell className="px-3 py-1.5 align-middle">
                                                            <span className="text-[11px] font-medium text-slate-700 truncate block max-w-[240px]">{user?.email}</span>
                                                        </TableCell>
                                                        <TableCell className="px-3 py-1.5 text-center align-middle">
                                                            <Badge
                                                                variant="outline"
                                                                className={`px-1.5 py-0.5 rounded-md font-bold text-[8px] uppercase tracking-wide border pointer-events-none ${getRoleColor(user?.role)}`}
                                                            >
                                    ...
                                    <div className="grid grid-cols-1 gap-4 p-4 md:hidden">
                                        {users?.map((user) => (
                                            <Card key={user?.id} className="border border-slate-200 shadow-sm overflow-hidden rounded-xl bg-white">
                                                <CardContent className="p-4 space-y-4">
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center gap-3">
                                                            <div className="h-10 w-10 rounded-lg bg-gradient-to-tr from-primary to-indigo-600 flex items-center justify-center font-bold text-white text-xs shadow-sm">
                                                                {user?.firstName?.[0]}{user?.lastName?.[0]}
                                                            </div>
                                                            <div>
                                                    ...
                                                    <div className="space-y-2 border-t border-slate-50 pt-3">
                                                        <div className="flex justify-between items-center text-xs">
                                                            <span className="font-bold text-slate-400 uppercase tracking-widest text-[9px]">Email</span>
