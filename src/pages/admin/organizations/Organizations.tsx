                          ...
                          <div className="flex gap-2 pt-2 border-t border-slate-50">
                            {!org.isVerified ? (
                              <Button
                                ...
                                size="sm"
                                onClick={() => handleVerify(String(org.id))}
                                className="flex-1 h-9 rounded-lg font-bold text-[10px] uppercase tracking-wider border-emerald-200 bg-emerald-50/50 text-emerald-600 hover:bg-emerald-50"
                              >
                                Approve
                              </Button>
                            ) : (
                              <Button
                                ...
                                size="sm"
                                onClick={() => handleOpenSetup(org)}
                                className="flex-1 h-9 rounded-lg border-slate-200 text-indigo-650 hover:bg-indigo-50 flex items-center justify-center gap-1.5"
                                title="Configure Tenant Database & Sync"
                              >
                                <Database className="h-3.5 w-3.5" />
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() => navigate(`/organizations/view/${org.id}`)}
                              className="h-9 w-9 rounded-lg border-slate-200 text-slate-600 hover:bg-slate-50 flex items-center justify-center"
                              title="View details"
                            >
                              <Eye className="h-3.5 w-3.5" />
                            </Button>
                            <Button
                              ...
                              size="sm"
                              onClick={() => navigate(`/organizations/edit/${org.id}`)}
                              className="h-9 w-9 rounded-lg border-slate-200 text-indigo-600 hover:bg-indigo-50 flex items-center justify-center"
                            >
                              <Edit className="h-3.5 w-3.5" />
                            </Button>
                            <Button
                              ...
                              size="sm"
                              onClick={() => openDeleteDialog(String(org.id))}
                              className="h-9 w-9 rounded-lg border-rose-200 text-rose-600 hover:bg-rose-50 flex items-center justify-center"
                            >
                              <Trash2 className="h-3.5 w-3.5" />
                            </Button>
                          </div>
