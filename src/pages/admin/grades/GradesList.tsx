                    ...
                    <CardHeader className="p-3 border-b border-slate-50">
                        <div className="flex flex-col sm:flex-row gap-2.5 justify-between items-center">
                            ...
                            <Button
                                ...
                                className="h-8 px-2.5 rounded-lg border-slate-200 text-slate-600 text-[9px] font-bold uppercase tracking-wide gap-1.5 flex-shrink-0"
                            >
                                    ...
                                    <Table>
                                        <TableHeader className="bg-slate-50">
                                            <TableRow className="border-slate-200 hover:bg-transparent">
                                                <TableHead className="px-3 py-2 text-[9px] font-black text-slate-500 uppercase tracking-wider w-[35%]">Grade Name</TableHead>
                                                <TableHead className="px-3 py-2 text-[9px] font-black text-slate-500 uppercase tracking-wider w-[40%]">Description</TableHead>
                                                <TableHead className="px-3 py-2 text-[9px] font-black text-slate-500 uppercase tracking-wider w-[10%]">Status</TableHead>
                                                ...
                                                <TableRow key={grade.id} className="border-slate-100 hover:bg-slate-50 transition-all duration-200 group">
                                                    <TableCell className="px-3 py-1.5 align-middle">
                                                        <div className="flex items-center gap-2.5">
                                                            ...
                                                            <p className="text-[11px] font-bold text-slate-900 group-hover:text-primary transition-colors truncate">
                                                                {grade.gradeName}
                                                            </p>
                                                        </div>
                                                    </TableCell>
                                                    <TableCell className="px-3 py-1.5 align-middle">
                                                        <div className="max-w-xs truncate text-[11px] font-medium text-slate-500" title={grade.description}>
                                                            {grade.description || <span className="text-slate-300 italic">No description</span>}
                                                        </div>
                                                    </TableCell>
                                                    <TableCell className="px-3 py-1.5 align-middle">
                                                        <span className={`px-1.5 py-0.5 text-[8px] uppercase rounded-full font-bold pointer-events-none ${grade.isActive !== false ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-500"}`}>
