        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-2">
          <div>
            ...
            {/* <h1 className="text-2xl font-black tracking-tight text-slate-900 flex items-center gap-2 mb-0.5">
              Dashboard <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-600">Console</span>
            </h1> */}
            {/* <p className="text-xs font-medium text-slate-500 max-w-2xl">
              Centralized dashboard for platform metrics and management.
            </p> */}
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
            <div>
              <h1 className="text-xl md:text-2xl font-black tracking-tight leading-tight">
                {greeting}, <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-600">{user?.name ? user.name.split(' ')[0] : 'Super Admin'}</span>
              </h1>
